...
UUID=${UUID:-'f9b5330f-dcff-4f1c-8d0c-f84febbe6a89'}
VMESS_WSPATH=${VMESS_WSPATH:-'/f9b5330f-dcff-4f1c-8d0c-f84febbe6a89-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/f9b5330f-dcff-4f1c-8d0c-f84febbe6a89-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/f9b5330f-dcff-4f1c-8d0c-f84febbe6a89-trojan'}
